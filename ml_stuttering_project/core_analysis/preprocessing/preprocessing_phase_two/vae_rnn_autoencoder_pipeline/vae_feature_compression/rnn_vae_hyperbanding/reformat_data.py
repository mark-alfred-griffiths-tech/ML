...
class ReformatData:
	...
	self.xtrain = tf.data.Dataset.from_tensor_slices().batch(self.batch_size)
	self.xtest = tf.data.Dataset.from_tensor_slices().batch(self.batch_size)
