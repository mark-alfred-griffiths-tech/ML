...
def tune_run_random_forest_phase_three():
    ...
    rf_rnn_three_better_default_dir = CreateRfRnnThreeDirectory(results_dir='/home/debian/RESULTS/')
    ...
    model_better_default = fit_model(model_better_default, data, rf_rnn_three_better_default_dir)

    OutputModel(rf_rnn_three_better_default_dir, model_better_default)
    ...
    os.chdir(rf_rnn_three_better_default_dir.rf_tf_better_default_three_layer_results)
    ...
    exit_message = 'RF BETTER DEFAULT THREE LAYER PARAMETERISED RAN SUCCESSFULLY IN: ' + str(time_delta)
