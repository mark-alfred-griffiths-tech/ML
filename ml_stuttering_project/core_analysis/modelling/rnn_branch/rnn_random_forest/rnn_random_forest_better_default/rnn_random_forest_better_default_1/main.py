...
def tune_run_random_forest_phase_one():
    ...
    rf_one_better_default_dir = CreateRfRnnOneDirectory(results_dir='/home/debian/RESULTS/')
    ...
    model_better_default = fit_model(model_better_default, data, rf_one_better_default_dir)

    OutputModel(rf_one_better_default_dir, model_better_default)
    ...
    os.chdir(rf_one_better_default_dir.rf_tf_better_default_one_layer_results)
    ...
    exit_message = 'RF BETTER DEFAULT ONE LAYER PARAMETERISED RAN SUCCESSFULLY IN: ' + str(time_delta)
    sys.exit(exit_message)

# RUN_ALL
tune_run_random_forest_phase_one()
