...
from tensorflow.keras.layers import Activation, Dense, GRU, Dropout, BatchNormalization, InputLayer
...
def build_model(hp):
    ...
    model = call_existing_code(ni_neurons, nj_neurons, nk_neurons, nl_neurons, ni_neurons_activation,
                               ...
                               ni_neurons_batch_normalisation_momentum,
                               ni_neurons_batch_normalisation_epsilon,
...
def call_existing_code(ni_neurons, nj_neurons, nk_neurons, nl_neurons, ni_neurons_activation, nj_neurons_activation,
                       nk_neurons_activation, nl_neurons_activation,
                       ni_neurons_dropout_value, nj_neurons_dropout_value, nk_neurons_dropout_value,
                       nl_neurons_dropout_value,
                       ni_neurons_batch_normalisation_momentum,
...
def run_tuner_get_best_hyperparameters(model_dir, project_name, epochs):
    tuner = kt.Hyperband(build_model, objective='accuracy', max_epochs=epochs, factor=3, directory=model_dir.mlp_tf_three_layer_pretraining,
