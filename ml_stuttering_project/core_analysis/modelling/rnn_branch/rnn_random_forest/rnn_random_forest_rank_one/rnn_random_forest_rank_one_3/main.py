...
def tune_run_random_forest_phase_three():
    ...
    rf_rnn_three_better_default_dir = CreateRfThreeDirectory(results_dir='/home/debian/RESULTS/')
    ...
    model_rank_one = fit_model(model_rank_one, data, rf_rnn_three_better_default_dir)

    OutputModel(rf_rnn_three_better_default_dir, model_rank_one)
