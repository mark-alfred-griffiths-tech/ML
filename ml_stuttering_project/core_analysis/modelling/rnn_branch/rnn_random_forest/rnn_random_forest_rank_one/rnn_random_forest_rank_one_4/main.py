...
def tune_run_random_forest_phase_four():
    ...
    rf_rnn_four_better_default_dir = CreateRfRnnFourDirectory(results_dir='/home/debian/RESULTS/')
    ...
    model_benchmark_rank1 = fit_model(model_benchmark_rank1, data, rf_rnn_four_better_default_dir)
    ...
    os.chdir(rf_rnn_four_better_default_dir.rf_tf_better_default_four_layer_results)
    ...
    OutputModel(rf_rnn_four_better_default_dir, model_benchmark_rank1)
