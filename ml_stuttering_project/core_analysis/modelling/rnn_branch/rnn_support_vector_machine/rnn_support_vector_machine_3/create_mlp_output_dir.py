...
class CreateRnnThreeDirectory:
    def __init__(self, results_dir, *args, **kwargs):
        ...
        self.rnn_tf_three_layer_epoch_select_model = self.propagate_dir(self.rnn_tf_three_layer,
                                                                       'rnn_tf_three_layer_epoch_select_model')
        ...
        self.rnn_tf_three_layer_tensorboard = self.propagate_dir(self.rnn_pretraining,
        ...
        self.rnn_tf_three_layer_partial_models = self.propagate_dir(self.rnn_tf_three_layer_pretraining,
                                                                   'rnn_tf_three_layer_partial_models')
