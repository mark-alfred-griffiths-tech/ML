...
def build_model(hp):
    ...
    model = call_existing_code(nk_neurons, nl_neurons, nk_neurons_activation, nl_neurons_activation,
...
def call_existing_code(nk_neurons, nl_neurons, nk_neurons_activation, nl_neurons_activation,
                       nk_neurons_dropout_value,
                       nl_neurons_dropout_value,
                       nk_neurons_batch_normalisation_momentum,
                       nk_neurons_batch_normalisation_epsilon,
