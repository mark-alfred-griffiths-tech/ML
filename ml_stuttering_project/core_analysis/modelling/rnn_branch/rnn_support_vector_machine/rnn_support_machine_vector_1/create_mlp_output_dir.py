...
class CreateRnnOneDirectory:
    def __init__(self, results_dir, *args, **kwargs):
        ...
        self.rnn_tf_one_layer_epoch_select_model = self.propagate_dir(self.rnn_tf_one_layer,
                                                                       'rnn_tf_one_layer_epoch_select_model')
