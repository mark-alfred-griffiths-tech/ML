...
from tensorflow.keras.layers import Activation, GRU, Dropout, BatchNormalization, InputLayer
...
def build_model(hp):
    ...
    model = call_existing_code(nj_neurons, nk_neurons, nl_neurons, nj_neurons_activation,
                               nk_neurons_activation, nl_neurons_activation, nj_neurons_dropout_value,
                               nk_neurons_dropout_value,
                               nl_neurons_dropout_value, nj_neurons_batch_normalisation_momentum,
                               nj_neurons_batch_normalisation_epsilon, nk_neurons_batch_normalisation_momentum,
...
def call_existing_code(nj_neurons, nk_neurons, nl_neurons, nj_neurons_activation,
                       nk_neurons_activation, nl_neurons_activation, nj_neurons_dropout_value, nk_neurons_dropout_value,
