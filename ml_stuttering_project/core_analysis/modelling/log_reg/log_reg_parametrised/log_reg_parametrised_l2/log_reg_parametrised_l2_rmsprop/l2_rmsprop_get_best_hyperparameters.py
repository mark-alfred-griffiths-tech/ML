...
def build_l2_rmsprop_model(hp):
    ...
    model = call_built_code_l2_rmsprop(bias_regularizer_value, kernel_regularizer_l2, kernel_regularizer_l2,
...
def run_tuner_get_best_hyperparameters_l2_rmsprop(model_dir, project_name, epochs):
    tuner = kt.Hyperband(build_l2_rmsprop_model, objective='accuracy', max_epochs=epochs, factor=3, overwrite=False, directory=model_dir.log_reg_l2_rmsprop_hyperbanding_pretraining, project_name=project_name)
