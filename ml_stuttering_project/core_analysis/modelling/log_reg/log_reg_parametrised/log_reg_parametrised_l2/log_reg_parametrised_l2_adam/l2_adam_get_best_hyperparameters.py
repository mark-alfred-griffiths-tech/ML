...
def run_tuner_get_best_hyperparameters_l2_adam(model_dir, project_name, epochs):
    tuner = kt.Hyperband(build_model_l2_adam, objective='accuracy', max_epochs=epochs, factor=3, overwrite=False, directory=model_dir.log_reg_l2_adam_hyperbanding_pretraining,
