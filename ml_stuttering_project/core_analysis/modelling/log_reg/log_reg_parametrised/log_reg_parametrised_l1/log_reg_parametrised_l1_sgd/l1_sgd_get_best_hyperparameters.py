...
def run_tuner_get_best_hyperparameters_l1_sgd(model_dir, project_name, epochs):
    tuner = kt.Hyperband(build_model_l1_sgd, objective='accuracy', max_epochs=epochs, factor=3, overwrite=False, directory=model_dir.log_reg_l1_sgd_hyperbanding_pretraining,
