...
class CreateMlpthreeDirectory:
    def __init__(self, results_dir, *args, **kwargs):
        ...
        self.mlp_tf_three_layer_epoch_select_model = self.propagate_dir(self.mlp_tf_three_layer,
                                                                       'mlp_tf_three_layer_epoch_select_model')
        ...
        self.mlp_tf_three_layer_tensorboard = self.propagate_dir(self.mlp_pretraining,
        ...
        self.mlp_tf_three_layer_partial_models = self.propagate_dir(self.mlp_tf_three_layer_pretraining,
                                                                   'mlp_tf_three_layer_partial_models')
