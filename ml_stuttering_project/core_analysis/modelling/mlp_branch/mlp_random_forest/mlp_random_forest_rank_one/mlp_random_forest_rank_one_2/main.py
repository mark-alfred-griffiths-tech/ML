...
def tune_run_random_forest_phase_two():
    ...
    rf_two_rank_one_dir = CreateRfTwoDirectory(results_dir='/home/debian/RESULTS/')
    ...
    OutputModel(rf_two_rank_one_dir, df_and_nn_model)
    ...
    os.chdir(rf_tf_two_dir.rf_tf_rank_one_two_layer_results)
