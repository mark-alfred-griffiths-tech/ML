...
class CreateMlpOneDirectory:
    def __init__(self, results_dir, *args, **kwargs):
        ...
        self.mlp_tf_one_layer_epoch_select_model = self.propagate_dir(self.mlp_tf_one_layer, 'mlp_tf_one_layer_epoch_select_model')
        self.mlp_tf_one_layer_pretraining = self.propagate_dir(self.mlp_tf_one_layer, 'mlp_tf_one_layer_pretraining')
        self.mlp_tf_one_layer_tensorboard = self.propagate_dir(self.mlp_tf_one_layer_pretraining,
